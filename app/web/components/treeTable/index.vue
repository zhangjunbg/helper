<template>
 <el-table ref="multipleTable" :data="formatData" :row-style="showRow" v-bind="$attrs">   <!--  @header-click="chooseall" -->
    ...
    <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="text" @click="handleEvent('edit',scope.$index, scope.row)">编辑</el-button>
          <el-button type="text" @click="handleEvent('del',scope.$index, scope.row)">删除</el-button>
        </template>
      </el-table-column>
