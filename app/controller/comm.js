...
module.exports = class CommController extends egg.Controller {
  ...
  async insert(ctx) {
    ...
    // ctx.model.Article.create(post,callback);


    const articleddddd = new ctx.model.Article(post)
    //   (err, t) => {
    //     // console.log("------------------------------------------------");
    //     // console.log(err);
    //     // console.log("------------------------------------------------");
    ...
    // const ctx = this.ctx
    // return ctx.model.Article(post,res => {
    ...
    articleddddd.save(function (err, t) {
      console.log("------------------------------------------------");
      console.log(err);
      console.log("------------------------------------------------");
      console.log(t);
    ...
    ctx.body = articleddddd;
    // ctx.body = res.data;
  }
  // async findeee(ctx) {

  //  let a = ctx.model.Article.find().exec(function (err,ddd){
  //   console.log("------------2-------------------");
  //   console.log(ddd);
  //  });
  //  console.log("------------3-------------------");
